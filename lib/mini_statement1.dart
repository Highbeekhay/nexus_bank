...
import 'package:nexus_bank/mini_statement2.dart';
import 'package:nexus_bank/mobile_t1.dart';

class MiniStatement1 extends StatelessWidget {
  const MiniStatement1({super.key});
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const MiniStatement2(),
                            ),
                          );
                        },
                        child: Column(
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const MobileT1(),
                            ),
                          );
                        },
                        child: Column(
